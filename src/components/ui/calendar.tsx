  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-12 h-9 font-normal text-xs flex items-center justify-center",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-12 w-12 p-0 font-normal text-sm aria-selected:opacity-100"),
